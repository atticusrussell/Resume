        ...
        %------WORK-EXP-------------
            \section{Work Experience}
                \resumeSubHeadingListStart
                    ...
                    \resumeSubsection{iD Tech Camps: Instructor}{Williamsburg, VA}
                    {\textit{iD Tech Camps: William and Mary Campus} \newline Taught multiple courses to campers ranging from ages 10-17. Taught Java and Python coding, and basic Linux and circuitry on Raspberry Pi}{June--July 2018} 
                \resumeSubHeadingListEnd
        %---------------------------
