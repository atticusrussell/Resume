...
\documentclass[letterpaper, 11pt]{article}
    ...
    \begin{document}
        %------------HEADER---------
            ...
            \robotoMed Seeking an Engineering Co-op, focusing on Hardware design and Low-Level Hardware and software for Spring-Summer 2020
        %---------------------------
		...
		%------SKILLS---------------
            \section{Skills}
                \resumeSubHeadingListStart
                    \resumeItem{Languages}{Arm Assembly, VHDL,  Python, Java, \LaTeX\xspace, Arduino C, Bash}
					\resumeItem{Tools}{Xilinx Vivado, Git, KiCad, Altera Quartus II, ModelSim, Linux Based Operating Systems}
            ...
            \section{Projects}
                \resumeSubHeadingListStart
                    ...
                    \resumeSubsection
                        ...
                        {The Giant 3D printer project is a project through 
                        Engineering House for ImagineRIT that aims to build a 3D 
                        Printer with a large printing space and the ability to 
                        potentially double as a CNC mill and laser engraver.}
                        {Sept '18 - March '19}
                    \resumeSubHeadingListEnd
        %---------------------------
        ...
        Robotics. Additionally taugh various encryption methods with Python}{June-August '18, '19} 
        ...
        Programming in C(CMPE-380). Assisted students understand the material, graded turned in items including technical lab reports.}{August '18-Present}
					% \resumeSubsection{Audio Video Responder}{Rochester, NY}
					% {\textit{Classroom Technology Support}\newline Provides
                    % technical support to professors and other patrons who use
                % the classrooms and A/V systems provided by the
            % University.}{January--December '18}
                \resumeSubHeadingListEnd
        %---------------------------
            ...
            \section{Organizations}
                \resumeSubHeadingListStart
                    ...
                    \resumeSubsection[codeRIT.org]
                        ...
                        {codeRIT is RIT's student organization that encourages
                        the hacker culture at RIT by promoting other school's
                        hackathons, and hosting BrickHack, RIT's premier
                        hackathon, an MLH member event. I am an organizer for
                        BrickHack, and am on the Travel, Logistics and Sponsorship
                        committees.}{February--August '18}
				\resumeSubHeadingListEnd
        %---------------------------
    \end{document}
