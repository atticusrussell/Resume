...
\begin{center}
  ...
  \begin{minipage}[b]{0.33\textwidth}
    ...
    U.S. Citizen \\
    \phantom{\href{https://github.com/atticusrussell}{github.com/AtticusRussell}}
  \end{minipage}
  \begin{minipage}[b]{0.33\textwidth}
    \raggedleft
...
\resumeSubHeadingListStart
    ...
    GPA: 3.31 - \href{https://meritpages.com/atticusrussell}{Dean's List}: Spring '22, Spring '20}{Expected May '23}
    {
    \phantom{A}Relevant Coursework:
    \begin{itemize}
        \resumeItem{Applied Programming in C (CMPE-380)}{Learned C programming in the Linux environment}
        \resumeItem {Intro to Software Engineering (SWEN-261)}{Developed and practiced the ability to work using Java in a team with other software developers, in an Agile work environment}
    \end{itemize}
    }
...
\resumeSubHeadingListStart
    \resumeSubsectionNoIndent{\href{https://vanteon.com}{Vanteon Corporation}: Electrical Engineering Co-op}{Pittsford, NY}{
        ...
        \begin{itemize}
            \item Overhauled Matlab script for characterization of test data
...
\resumeSubHeadingListStart
    ...
    \resumeSubsection{Small Scale Autonomous Race Car}{Embedded C}{
