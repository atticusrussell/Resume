...
\resumeSubHeadingListStart
    ...
    GPA: 3.28  \hspace{0.2cm} \href{https://meritpages.com/atticusrussell}{Dean's List}: Spring '22, Spring '20}{Expected Aug. '23}
    {
...
\section{Skills}
\skillsListStart
    \resumeItem{Languages}{C, C++, Python, VHDL, Matlab,  Arm Assembly,
      \LaTeX\xspace, Bash, Java}
    \resumeItem{Tools}{GNU/Linux environment, ROS2, Git, ModelSim, Xilinx Vivado, Altium, CAD}
    \resumeItem{Technical}{Debugging, troubleshooting, soldering, robotics,
    embedded software}
    \resumeItem{Professional Skills}{Presentations, Scrum framework, Agile
    methodology}
